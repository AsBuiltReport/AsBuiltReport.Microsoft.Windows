function Invoke-AsBuiltReport.Microsoft.Windows {
    <#
    .SYNOPSIS
        PowerShell script to document the configuration of Microsoft Windows in Word/HTML/Text formats
    .DESCRIPTION
        Documents the configuration of Microsoft Windows in Word/HTML/Text formats using PScribo.
    .NOTES
        Version:        0.1.0
